...
cv_file = cv2.FileStorage("../ii/depth_estmation_params_py.xml", cv2.FILE_STORAGE_READ)
...
cv_file = cv2.FileStorage("../iii/depth_estmation_params_py.xml", cv2.FILE_STORAGE_WRITE)
